...
def write_files(song_file: str, argb: tuple) -> None:
    with Image.open("./Spectrograms/Processed/Spectrograms/" + song_file) as im:
        im.putpixel((0, 0), argb)
        im.save("./Spectrograms/Processed/Spectrograms/" + song_file, "PNG")
    with Image.open("./Spectrograms/Processed/MelSpectrograms/" + song_file) as im:
        im.putpixel((0, 0), argb)
        im.save("./Spectrograms/Processed/MelSpectrograms/" + song_file, "PNG")
