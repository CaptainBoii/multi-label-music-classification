...
for file in test_files:
    ...
    shutil.copyfile(spectrogram_data + file_redux,
                    training_data + file_redux)
    shutil.copyfile(melspectrogram_data + file_redux,
                    mel_training_data + file_redux)
...
for genre in genres:
    ...
    data_positive = {
        "Valid": positive_files[:k],
        "Train": positive_files[k:]
    }

    negative_files = list(set(all_files) - set(positive_files))
    random.shuffle(negative_files)
    data_negative = {
        "Valid": negative_files[:k],
        "Train": negative_files[k:]
    }
